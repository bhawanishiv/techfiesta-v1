...
<!-- Gallery Coading  Start -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 image">
          <div class="thumbnail">
            ...
            <img src="gallery/m1.jpg" id="pic1" alt="techfiesta Instiated">
          </div>
        </div>
        ...
        <div id="box1" class="box">
         ...
         <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 image">
          <div class="thumbnail">
            ...
            <img src="gallery/m2.jpg" id="pic2" alt="techfiesta Instiated">
 ...
 <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 image">
          <div class="thumbnail">
            ...
            <img src="gallery/m3.jpg" id="pic3" alt="techfiesta Instiated">
