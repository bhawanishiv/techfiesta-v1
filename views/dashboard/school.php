<div ng-controller="dashboardSchoolCtrl">
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large red">
            <i class="large material-icons">mode_edit</i>
        </a>
        <ul>
            <li><a class="btn-floating red modal-trigger" href="#modalAddSchoolEvent"><i class="material-icons">add</i></a></li>
            <li><a class="btn-floating  blue modal-trigger" href="#modalScholEditEvent"><i class="material-icons">edit</i></a></li>
            <li><a class="btn-floating  orange modal-trigger" href="#modalAddSchoolEventDate"><i class="material-icons">event</i></a></li>
            <li><a class="btn-floating  purple modal-trigger" href="#modalAddSchoolEventVenue"><i class="material-icons">edit_location</i></a></li>
    ...
    <ul class="collapsible popout">
        <li ng-repeat="event in events| orderBy: sortSearchEvent?'-' + filterSearchEvent:filterSearchEvent | filter:searchEvent" ng-if="event.department.name=='School Event'">
    ...
    <div id="modalAddSchoolEvent" class="modal bottom-sheet">
        <div ng-if="profile.permission.account && profile.type == 'superadmin'">
            <form name="frmAddEvent" validate ng-submit="postSchoolEvent(_event)">  .
                <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="input-field col s12 l2">
                            ...
                            <span class="helper-text red-text" ng-if="frmAddEvent.eventId.$touched && frmAddEvent.eventId.$error.required">{{web.data.requiredfield}}</span> 
                        </div> 
                        <div class="input-field col s12 l3">
    ...
    <div id="modalAddSchoolEventDate" class="modal bottom-sheet">
        <div ng-if="profile.permission.account && profile.type == 'superadmin'">
    ...
    <div id="modalAddSchoolEventVenue" class="modal bottom-sheet">
        <div ng-if="profile.permission.account && profile.type == 'superadmin'">
